...
def main():
    ...
    addItem("banana", -2, logs)  # This will reduce banana stock if already present or add negative quantity
    addItem("123", 10, logs)  # corrected item to string "123"
    removeItem("apple", 3)
    removeItem("orange", 1)  # Item not present case handled in removeItem
    print("Apple stock:", getQty("apple"))
    print("Low items:", checkLowItems())
    saveData()
    loadData()
    printData()
    # Removed use of eval for safety
